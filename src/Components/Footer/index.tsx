    ...
    return (
        <FooterStyled style={{ color: "white" }}>
            <ContainerAnchorStyled>
                <a href="https://github.com/PagaNiz" target='_blank'>
                    <LogoSocialFooterStyled width="18px" height="18px" viewBox='0 0 100 100' xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.linkedin.com/in/paganilukz/" target='_blank'>
                    <LogoSocialFooterStyled fill="#ffffff" height="18px" width="18px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="-143 145 512 512">
